class LibraryBookIssueAsync implements Runnable {
    ...
    public void run(){
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            if (books > 0) {
                ...
                System.out.println(t.getName() + " failed (No books available)");
            }
        }
    }
    ...
    public static void main(String args[]) {
        ...
        LibraryBookIssueAsync obj = new LibraryBookIssueAsync();
        ...
        System.out.println("Library Book Issue Started (Async)\n");
